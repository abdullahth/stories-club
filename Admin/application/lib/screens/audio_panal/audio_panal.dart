...
class AudioPanal extends StatefulWidget {
  const AudioPanal({Key? key}) : super(key: key);

  @override
  _AudioPanalState createState() => _AudioPanalState();
}

class _AudioPanalState extends State<AudioPanal>
  ...
  Widget build(BuildContext context) {
    final _audios = Provider.of<AudioProvider>(context);
    super.build(context);
                ...
                child: Table(
                  ...
                  children: [
                    ...
                    ...List.generate(
                        data.length,
                        (i) =>
                            buildAudioTableRow(context, audioInstance: data[i],
                                deleteCallback: () async {
                              await _audios.deleteAudio(data[i].id);
                              setState(() {});
                            }))
                  ],
                ),
